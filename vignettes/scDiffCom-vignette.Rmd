...
**Note: all the results below do not convey any meaningful biology.**
...
humand and mouse), retrieved from eight previous studies.


Although the call to the LRI databases is made internally, you can still 
access and explore them as follows:
```{r}
...
All results can be obtained by simply calling `run_interaction_analysis`. The
...
# Plot, e.g., the top LRIs down-regulated
