...
# dt_ora = dt_ora[MERGE_MODE %in% c("ancestors_intersection", "ancestors_union", "ancestors_ligands", "ancestors_receptors", "intersection")]

violin_plot = ggplot(data=dt_ora, aes(fill=TYPE, y=LEVEL, x=MERGE_MODE)) + 
  geom_violin() + 
  ...
  ylab("Level") +
  ggtitle("Distribution of GO Term level by merging modes and over-representation type") +
